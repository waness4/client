...
import { Layout, Archive, CircleDollarSign, User, SlidersHorizontal, Clipboard, Menu, LucideIcon } from 'lucide-react';
  ...
  return (
    <div className={sidebarClassNames}>
      ...
      >
        ...
        <h1 className={` ${isSidebarCollapsed ? "hidden" : "block"} font-extrabold text-2xl`}>Wanessa</h1>
      ...
      <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
        <p className='text-center text-xs text-gray-500'>&copy; 2024 Wanessa</p>
      </div>
    </div >
  );
};
